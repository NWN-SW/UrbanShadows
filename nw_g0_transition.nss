...
void main()
{
    ...
    //Prevent NPCs from changing areas.
    object oMaster = GetMaster(oClicker);
    effect eHeal = EffectHeal(99999);
    if(!GetIsPC(oClicker) && oMaster == OBJECT_INVALID)
    {
        ApplyEffectToObject(DURATION_TYPE_INSTANT, eHeal, oClicker);
