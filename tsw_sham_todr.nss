...
// End of Spell Cast Hook
    ...
    effect eAOE = EffectAreaOfEffect(68);
    ...
    object oPlaceable = CreateObject(OBJECT_TYPE_PLACEABLE, "shamantotemdread", lTarget, FALSE, GetName(oCaster) + "_FTOTEM");
    ...
    DoClassMechanic("Debuff", "AOE", 0, oCaster);
