    ...
    while (GetIsObjectValid(oTarget))
    {
        ...
        if (GetRacialType(oTarget) == RACIAL_TYPE_UNDEAD )
        {
            if(!GetIsReactionTypeFriendly(oTarget))
            {
                ...
                if (!MyResistSpell(OBJECT_SELF, oTarget, fDelay))
                {
                    ...
                    int nDamage = GetFifthLevelDamage(oHeal, nCasterLvl, nMetaMagic, "AoE");
        ...
        else
        {
            ...
            if(!GetIsReactionTypeHostile(oTarget) || GetFactionEqual(oTarget))
            {
                ...
                //Roll damage for each target
                int nHP = GetFifthLevelDamage(oTarget, nCasterLvl, nMetaMagic, "AoE");
                ...
                int nBonusDC = GetFocusDC(OBJECT_SELF, sElement);
                nDC = nDC + nBonusDC;
                nHP = GetFocusDmg(OBJECT_SELF, nHP, sElement);
                //Set healing effect
