...
//Primal versions
const int POLYMORPH_TYPE_WEREWOLF_H = 107;
const int POLYMORPH_TYPE_WEREBEAR_H = 108;
const int POLYMORPH_TYPE_WERECAT_H = 109;
const int POLYMORPH_TYPE_WEREHAWK_H = 110;
const int POLYMORPH_TYPE_WEREBULL_H = 111;

//Basic versions
const int POLYMORPH_TYPE_WEREWOLF_N = 112;
const int POLYMORPH_TYPE_WEREBEAR_N = 113;
const int POLYMORPH_TYPE_WERECAT_N = 114;
const int POLYMORPH_TYPE_WEREHAWK_N = 115;
const int POLYMORPH_TYPE_WEREBULL_N = 116;
