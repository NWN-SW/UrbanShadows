...
// End of Spell Cast Hook
    ...
    int nMax = 99999;// maximun hd creature affected, set this to 9 so that a lower HD creature is chosen automatically
    ...
    while ((nHD > 0) && (bContinueLoop))
    {
        ...
        if(bContinueLoop == TRUE)
        {
            ...
            if(!MyResistSpell(OBJECT_SELF, oLowest, fDelay))
            {
                ...
                DelayCommand(fDelay, ApplyEffectToObject(DURATION_TYPE_INSTANT, eDam, oLowest));
