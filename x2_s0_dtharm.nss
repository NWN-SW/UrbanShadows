...
void main()
{
    ...
    */
    ...
    object oNotSelf;
    int nDamage = GetSecondLevelDamage(oNotSelf, nCasterLvl, nMetaMagic, "AOE");
    nDamage = GetFocusDmg(OBJECT_SELF, nDamage, "Nega");

    effect eShield = EffectDamageShield(nDamage, DAMAGE_BONUS_1d4, DAMAGE_TYPE_MAGICAL);
