//Cannibal Investigation Part Six
...
void main()
{
    ...
    while(oParty != OBJECT_INVALID)
    {
        ...
        if(nCheck == 5 && GetArea(oPC) == GetArea(oParty))
        {
            AddJournalQuestEntry("Cannibal_Puzzle", 6, oParty, FALSE);
            CreateItemOnObject("cannibal_thing6", oParty);
            SQLocalsPlayer_SetInt(oParty, "CANNIBAL_PUZZLE", 6);
        }
