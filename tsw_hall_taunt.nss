//::///////////////////////////////////////////////
//:: Hallucination Taunt by Alexander G.
//:://////////////////////////////////////////////
...
void main()
{
    ...
    effect eBeam = EffectBeam(VFX_BEAM_ODD, OBJECT_SELF, BODY_NODE_CHEST, FALSE, 2.0);
    string sTargets;
    string sElement;
    int nTotalDamage;
    int nReduction;
    ...
    location lVFX;
    int nVFXCounter;
    effect eExplode = EffectVisualEffect(VFX_IMP_HEAD_MIND, FALSE, 1.5, [0.0,0.0,0.6]);
    while(nVFXCounter < 4)
    {
    ...
    while(GetIsObjectValid(oTarget))
    {
        if (GetIsReactionTypeHostile(oTarget) && oTarget != OBJECT_SELF)
        {
            ...
            if(nDamage > 0)
            {
                ...
                effect eFire = EffectDamage(nFinalDamage, DAMAGE_TYPE_MAGICAL);
                ...
                //Do jump script
                ExecuteScript("tsw_cham_jump", oTarget);
            }
        }
