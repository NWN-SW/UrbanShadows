//::///////////////////////////////////////////////
//:: Wail of the Banshee by Alexander G.
//:://////////////////////////////////////////////
...
// End of Spell Cast Hook
    ...
    oTarget = GetFirstObjectInShape(SHAPE_SPHERE, fSize, GetSpellTargetLocation(), OBJECT_TYPE_CREATURE);
    ...
    while(GetIsObjectValid(oTarget))
    {
        if (spellsIsTarget(oTarget, SPELL_TARGET_SELECTIVEHOSTILE, OBJECT_SELF) && oTarget != OBJECT_SELF)
        {
            ...
            if(nDamage > 0)
            {
                  ...
                  effect eFire = EffectDamage(nFinalDamage, DAMAGE_TYPE_NEGATIVE);
