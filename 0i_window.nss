...
const int PM_OPTIONS = FALSE;
const int PM_BUG_REPORT = FALSE;
const int PM_DESCRIPTION = TRUE;
const int PM_DICE = TRUE;
const int PM_TELEPORT = FALSE;
const int PM_SUMMONS = FALSE;
...
json CreateLabel (json jRow, string sBind, float fWidth, float fHeight);
    ...
    //COMMENTED OUT LINE 62 by FallenDabus 17.08.2024 to try to fix compile error.
