...
void AddBlackStaffEffectOnWeapon (object oTarget, float fDuration)
{
    ...
    IPSafeAddItemProperty(oTarget, ItemPropertyOnHitProps(IP_CONST_ONHIT_DISPELMAGIC, IP_CONST_ONHIT_SAVEDC_20), fDuration,X2_IP_ADDPROP_POLICY_REPLACE_EXISTING );
    ...
    //Extra Effects
    IPSafeAddItemProperty(oTarget, ItemPropertyVampiricRegeneration(10), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE, TRUE);
    IPSafeAddItemProperty(oTarget, ItemPropertyLight(3, 3), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE, TRUE);
    IPSafeAddItemProperty(oTarget, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_NEGATIVE, IP_CONST_DAMAGEBONUS_2d6), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE, TRUE);
    return;
}
