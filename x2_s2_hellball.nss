    ...
    */
    ...
    while (GetIsObjectValid(oTarget))
    {
        if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
        {
            ...
            eDam1 = EffectDamage(nFinalDamage, DAMAGE_TYPE_FIRE);
    ...
    DelayCommand(fDelay, DoClassMechanic(sSpellType, sTargets, nFinalDamage, oMainTarget, oCaster));
}
