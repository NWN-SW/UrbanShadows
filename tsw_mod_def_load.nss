...
void main()
{
   ...
   if (GetGameDifficulty() ==  GAME_DIFFICULTY_CORE_RULES || GetGameDifficulty() ==  GAME_DIFFICULTY_DIFFICULT)
   {
    ...
    //TSW TLK OVERRIDES
    ExecuteScript("tsw_tlk_override");

    //New limits
    SetSavingThrowBonusLimit(100);
    SetAttackBonusLimit(25);
   ...
   NWNX_Events_SubscribeEvent(NWNX_ON_COMBAT_ATTACK_OF_OPPORTUNITY_BEFORE, "tsw_on_opp");

   //Buzzer Global Tracker
   //int nBuzzerMsgLatest = GetLocalInt(GetModule(), "nModuleBuzzer");
    ...
    //Attempt for Buzzer to refresh automatically
    SetLocalInt(GetModule(), "nModuleBuzzerStart", nMostRecentMsg);
    SetLocalInt(GetModule(), "nModuleBuzzer", nMostRecentMsg);
