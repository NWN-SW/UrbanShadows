...
// End of Spell Cast Hook
    ...
    effect eSummon = EffectSummonCreature("summ_blackblade2");
    ...
    //Check for Epic Conjuration Focus
    if(GetHasFeat(FEAT_EPIC_SPELL_FOCUS_CONJURATION))
    {
        eSummon = EffectSummonCreature("summ_blackblade1");
    }
    //Apply the VFX impact and summon effect
    ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, eVis, GetSpellTargetLocation());
    ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, eSummon, GetSpellTargetLocation(), RoundsToSeconds(nDuration));
    DelayCommand(1.0, ApplySummonStats(11));
