...
void main()
{
    ...
    //Make sure the summon's power doesn't get TOO ridiculous.
    if (nCasterLevel > 15)
    {
        nCasterLevel = 15;
    }
    ...
    effect eSummon;
    //Summon the Pale Bone Golem
    eSummon = EffectSummonCreature("summ_pm_war1",VFX_IMP_HARM,0.0f,0);
    ...
    DelayCommand(1.0, ApplySummonStats(nCasterLevel));
