...
//:: Sets quest stage to stage 5 if character declines Sommerset's Job.
...
void main()
{
    ...
    if(nCheck <= 4)
    {
        SQLocalsPlayer_SetInt(GetPCSpeaker(), "Q_FEYEST01", 6);
        AddJournalQuestEntry("Q_FeyEst01", 6, GetPCSpeaker(), FALSE);
		//AddReputation(oPC, 6);
    }
}
