...
// End of Spell Cast Hook
    ...
    effect eAOE = EffectAreaOfEffect(69);
    ...
    object oPlaceable = CreateObject(OBJECT_TYPE_PLACEABLE, "shmntotemagony", lTarget, FALSE, GetName(oCaster) + "_FTOTEM");
