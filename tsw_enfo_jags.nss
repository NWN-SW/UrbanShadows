...
// End of Spell Cast Hook
    ...
    location lVFX;
    int nVFXCounter;
    effect eExplode = EffectVisualEffect(VFX_IMP_STARBURST_RED, FALSE, 1.5, [0.0,0.0,0.6]);
    while(nVFXCounter < 5)
    {
        fDelay2 = fDelay2 + 0.1;
    ...
    DelayCommand(0.1, PlaySoundByStrRef(16778116, FALSE));
    DelayCommand(0.2, PlaySoundByStrRef(16778116, FALSE));
}
