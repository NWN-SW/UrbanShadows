//::///////////////////////////////////////////////
//:: Storm of Castigation by Alexander G.
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int nAmount = GetHighestAbilityModifier(oCaster) * 5;
    ...
    location lVFX;
    int nVFXCounter;
    effect eExplode = EffectVisualEffect(964, FALSE, 1.5, [0.0,0.0,0.6]);
    while(nVFXCounter < 5)
    {
    ...
    DoMartialMechanic("Buff", sTargets, nTotalDamage, oMainTarget);
