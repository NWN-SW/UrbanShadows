//Cannibal Investigation Part Four
...
void main()
{
    ...
    while(oParty != OBJECT_INVALID)
    {
        ...
        if(nCheck == 3 && GetArea(oPC) == GetArea(oParty))
        {
            AddJournalQuestEntry("Cannibal_Puzzle", 4, oParty, FALSE);
            CreateItemOnObject("cannibal_thing5", oParty);
            SQLocalsPlayer_SetInt(oParty, "CANNIBAL_PUZZLE", 4);
        }
